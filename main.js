   ...
   $("#emoji li:nth-child(1)").hover(function(){
      $("#dot").css("margin-left","0px");
       function explode(){
		   ...
		   $("#note li:nth-child(1)").css("font-size","14px");
           $("#note li:nth-child(2)").css("font-size","13px");
           $("#note li:nth-child(3)").css("font-siz","13px");
           $("#note li:nth-child(4)").css("font-size","13px");
           $("#note li:nth-child(5)").css("font-size","13px");
		   $("#note li:nth-child(1)").css("font-weight","bold");
           $("#note li:nth-child(2)").css("font-weight","unset");
		   $("#note li:nth-child(3)").css("font-weight","unset");
		   $("#note li:nth-child(4)").css("font-weight","unset");
		   $("#note li:nth-child(5)").css("font-weight","unset");
       }
    ...
    $("#emoji li:nth-child(2)").hover(function(){
      $("#dot").css("margin-left","60px");
       function explode(){
           ...
           $("#note li:nth-child(4)").css("color","#3A6D88");
           $("#note li:nth-child(5)").css("color","#3A6D88");
		   $("#note li:nth-child(1)").css("font-size"," 13px");
           $("#note li:nth-child(2)").css("font-size","14px");
           $("#note li:nth-child(3)").css("font-size","13px");
           $("#note li:nth-child(4)").css("font-size","13px");
           $("#note li:nth-child(5)").css("font-size","13px");
		   $("#note li:nth-child(1)").css("font-weight","unset");
		   $("#note li:nth-child(2)").css("font-weight","bold");
		   $("#note li:nth-child(3)").css("font-weight","unset");
		   $("#note li:nth-child(4)").css("font-weight","unset");
		   $("#note li:nth-child(5)").css("font-weight","unset");
    ...
    $("#emoji li:nth-child(3)").hover(function(){
      $("#dot").css("margin-left","120px");
       function explode(){
		   ...
		   $("#note li:nth-child(1)").css("font-size","13px");
           $("#note li:nth-child(2)").css("font-size","13px");
           $("#note li:nth-child(3)").css("font-size","14px");
           $("#note li:nth-child(4)").css("font-size","13px");
           $("#note li:nth-child(5)").css("font-size","13px");
		   $("#note li:nth-child(1)").css("font-weight","unset");
		   $("#note li:nth-child(2)").css("font-weight","unset");
		   $("#note li:nth-child(3)").css("font-weight","bold");
		   $("#note li:nth-child(4)").css("font-weight","unset");
		   $("#note li:nth-child(5)").css("font-weight","unset");
    ...
    $("#emoji li:nth-child(4)").hover(function(){
      $("#dot").css("margin-left","180px");
       function explode(){
           ...
           $("#note li:nth-child(2)").css("font-size","13px");
           $("#note li:nth-child(3)").css("font-size","13px");
           $("#note li:nth-child(4)").css("font-size","14px");
           $("#note li:nth-child(5)").css("font-size","13px");
		   $("#note li:nth-child(1)").css("font-weight","unset");
		   $("#note li:nth-child(2)").css("font-weight","unset");
		   $("#note li:nth-child(3)").css("font-weight","unset");
		   $("#note li:nth-child(4)").css("font-weight","bold");
		   $("#note li:nth-child(5)").css("font-weight","unset");
    ...
    $("#emoji li:nth-child(5)").hover(function(){
      $("#dot").css("margin-left","240px");
       function explode(){
           ...
           $("#note li:nth-child(3)").css("font-size","13px");
           $("#note li:nth-child(4)").css("font-size","13px");
           $("#note li:nth-child(5)").css("font-size","14px");
		   $("#note li:nth-child(1)").css("font-weight","unset");
		   $("#note li:nth-child(2)").css("font-weight","unset");
		   $("#note li:nth-child(3)").css("font-weight","unset");
		   $("#note li:nth-child(4)").css("font-weight","unset");
		   $("#note li:nth-child(5)").css("font-weight","bold");
